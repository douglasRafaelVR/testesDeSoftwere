...
= Sistema Bancário para Testes com JUnit 5 (link:https://kinolien.github.io/gitzip/?download=/ifto-palmas/testes-de-software/tree/master/projects/02-sistema-bancario[zip])
